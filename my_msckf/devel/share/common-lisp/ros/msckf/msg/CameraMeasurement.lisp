...
(cl:defclass <CameraMeasurement> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (features
    :reader features
    :initarg :features
    :type (cl:vector msckf-msg:FeatureMeasurement)
   :initform (cl:make-array 0 :element-type 'msckf-msg:FeatureMeasurement :initial-element (cl:make-instance 'msckf-msg:FeatureMeasurement))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <CameraMeasurement>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CameraMeasurement)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msckf-msg:<CameraMeasurement> is deprecated: use msckf-msg:CameraMeasurement instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <CameraMeasurement>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msckf-msg:header-val is deprecated.  Use msckf-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'features-val :lambda-list '(m))
(cl:defmethod features-val ((m <CameraMeasurement>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msckf-msg:features-val is deprecated.  Use msckf-msg:features instead.")
  (features m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <CameraMeasurement>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'features)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'msckf-msg:FeatureMeasurement))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CameraMeasurement>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%# All features on the current image,~%# including tracked ones and newly detected ones.~%FeatureMeasurement[] features~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: msckf/FeatureMeasurement~%uint64 id~%# Normalized feature coordinates (with identity intrinsic matrix)~%uint64 lifetime~%float64 u0 # horizontal coordinate in cam0~%float64 v0 # vertical coordinate in cam0~%float64 u1 # horizontal coordinate in cam0~%float64 v1 # vertical coordinate in cam0~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CameraMeasurement)))
  "Returns full string definition for message of type 'CameraMeasurement"
  (cl:format cl:nil "std_msgs/Header header~%# All features on the current image,~%# including tracked ones and newly detected ones.~%FeatureMeasurement[] features~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: msckf/FeatureMeasurement~%uint64 id~%# Normalized feature coordinates (with identity intrinsic matrix)~%uint64 lifetime~%float64 u0 # horizontal coordinate in cam0~%float64 v0 # vertical coordinate in cam0~%float64 u1 # horizontal coordinate in cam0~%float64 v1 # vertical coordinate in cam0~%~%"))
