...
(cl:defmethod cl:initialize-instance :after ((m <FeatureMeasurement>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FeatureMeasurement)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msckf-msg:<FeatureMeasurement> is deprecated: use msckf-msg:FeatureMeasurement instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <FeatureMeasurement>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msckf-msg:id-val is deprecated.  Use msckf-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'lifetime-val :lambda-list '(m))
(cl:defmethod lifetime-val ((m <FeatureMeasurement>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msckf-msg:lifetime-val is deprecated.  Use msckf-msg:lifetime instead.")
  (lifetime m))

(cl:ensure-generic-function 'u0-val :lambda-list '(m))
(cl:defmethod u0-val ((m <FeatureMeasurement>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msckf-msg:u0-val is deprecated.  Use msckf-msg:u0 instead.")
  (u0 m))

(cl:ensure-generic-function 'v0-val :lambda-list '(m))
(cl:defmethod v0-val ((m <FeatureMeasurement>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msckf-msg:v0-val is deprecated.  Use msckf-msg:v0 instead.")
  (v0 m))

(cl:ensure-generic-function 'u1-val :lambda-list '(m))
(cl:defmethod u1-val ((m <FeatureMeasurement>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msckf-msg:u1-val is deprecated.  Use msckf-msg:u1 instead.")
  (u1 m))

(cl:ensure-generic-function 'v1-val :lambda-list '(m))
(cl:defmethod v1-val ((m <FeatureMeasurement>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msckf-msg:v1-val is deprecated.  Use msckf-msg:v1 instead.")
  (v1 m))
