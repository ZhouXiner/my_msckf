...
"""autogenerated by genpy from msckf/CameraMeasurement.msg. Do not edit."""
import sys
...
float64 v1 # vertical coordinate in cam0"""
  ...
  _slot_types = ['std_msgs/Header','msckf/FeatureMeasurement[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = msckf.msg.FeatureMeasurement()
        _x = val1
        start = end
        end += 48
