...
if(msckf_CONFIG_INCLUDED)
  return()
endif()
set(msckf_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("FALSE" STREQUAL "TRUE")
  set(msckf_SOURCE_PREFIX /home/zhouxin/Documents/my_msckf/src/msckf)
  set(msckf_DEVEL_PREFIX /home/zhouxin/Documents/my_msckf/devel)
  set(msckf_INSTALL_PREFIX "")
  set(msckf_PREFIX ${msckf_DEVEL_PREFIX})
else()
  set(msckf_SOURCE_PREFIX "")
  set(msckf_DEVEL_PREFIX "")
  set(msckf_INSTALL_PREFIX /home/zhouxin/Documents/my_msckf/install)
  set(msckf_PREFIX ${msckf_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'msckf' is deprecated")
...
if(NOT "include;/usr/include;/usr/include/eigen3;/usr/local/include;/usr/local/include/opencv " STREQUAL " ")
  set(msckf_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include;/usr/include/eigen3;/usr/local/include;/usr/local/include/opencv")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'zhouxin <zhouxin@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${msckf_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'msckf' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'msckf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zhouxin/Documents/my_msckf/install/${idir}'.  ${_report}")
    endif()
    _list_append_unique(msckf_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND msckf_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND msckf_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT msckf_NUM_DUMMY_TARGETS)
      set(msckf_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::msckf::wrapped-linker-option${msckf_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR msckf_NUM_DUMMY_TARGETS "${msckf_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::msckf::wrapped-linker-option${msckf_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND msckf_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zhouxin/Documents/my_msckf/install/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(msckf_LIBRARY_DIRS ${lib_path})
      list(APPEND msckf_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'msckf'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND msckf_LIBRARIES ${lib})
    endif()
  endif()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 msckf_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${msckf_dep}_FOUND)
      find_package(${msckf_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${msckf_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(msckf_INCLUDE_DIRS ${${msckf_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(msckf_LIBRARIES ${msckf_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${msckf_dep}_LIBRARIES})
  _list_append_deduplicate(msckf_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(msckf_LIBRARIES ${msckf_LIBRARIES})

  _list_append_unique(msckf_LIBRARY_DIRS ${${msckf_dep}_LIBRARY_DIRS})
